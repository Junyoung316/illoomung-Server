...
public class BusinessTestServiceImpl implements BusinessTestService {
    ...
    private void saveStore(Account account, TestStoreCreateRequest storeCreateRequest, CryptoResult phoneCrypto, CryptoResult addressCrypto, CryptoResult addressDetailsCrypto, String depth1, String depth2, String depth3, String bCode) {
    ...
    @Override
    @Transactional
    public void createTestStore(TestStoreCreateRequest storeCreateRequest) {
